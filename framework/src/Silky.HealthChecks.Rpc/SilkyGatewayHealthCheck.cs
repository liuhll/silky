...
public class SilkyGatewayHealthCheck : SilkyHealthCheckBase
{
    public SilkyGatewayHealthCheck(IServerManager serverManager, IServerHealthCheck serverHealthCheck,
        ...
        IServiceEntryLocator serviceEntryLocator, IRpcEndpointMonitor rpcEndpointMonitor) : base(serverManager,
        serverHealthCheck, currentRpcToken, serializer, httpHandleDiagnosticListener, httpContextAccessor,
        serviceEntryLocator, rpcEndpointMonitor)
    {
    }
