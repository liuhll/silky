...
public static class TypeHelper
{
    ...
    public static string GetFullNameHandlingNullableAndGenerics([System.Diagnostics.CodeAnalysis.NotNull] Type type)
    {
    ...
    public static string GetSimplifiedName([System.Diagnostics.CodeAnalysis.NotNull] Type type)
    {
        Check.NotNull(type, nameof(type));
