...
public class SilkyConfigurationBuilderOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Whether the file type, Default value: Yaml.
    /// </summary>
    public ConfigurationFileType FileType { get; set; } = ConfigurationFileType.Yaml;
