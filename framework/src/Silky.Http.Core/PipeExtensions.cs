...
internal static partial class PipeExtensions
    {
        ...
        public static async Task WriteMessageAsync<TResponse>(this PipeWriter pipeWriter, TResponse response, HttpContextServerCallContext serverCallContext, Action<TResponse, HttpContextSerializationContext> serializer, bool canFlush)
        ...
        // public static async ValueTask<T> ReadSingleMessageAsync<T>(this PipeReader input, HttpContextServerCallContext serverCallContext, Func<HttpContextSerializationContext, T> deserializer)
        //     where T : class
        // {
        //     var logger = serverCallContext.Logger;
        //
