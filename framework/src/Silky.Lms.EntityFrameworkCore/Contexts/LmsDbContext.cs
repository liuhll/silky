...
using Silky.Lms.EntityFrameworkCore.Contexts.Builders;
...
namespace Silky.Lms.EntityFrameworkCore.Contexts
{
    ...
    public abstract class LmsDbContext<TDbContext> : LmsDbContext<TDbContext, MasterDbContextLocator>
        where TDbContext : DbContext
    {
        ...
        public LmsDbContext(DbContextOptions<TDbContext> options) : base(options)
        {
        }
    }
