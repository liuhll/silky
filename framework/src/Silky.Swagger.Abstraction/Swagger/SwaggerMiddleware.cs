    ...
    public class SwaggerMiddleware
    {
        ...
        private async Task RespondWithSwaggerJson(HttpResponse response, OpenApiDocument swagger)
        {
            ...
            using (var textWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if (_options.SerializeAsV2) swagger.SerializeAsV2(jsonWriter);
                else swagger.SerializeAsV3(jsonWriter);
        ...
        private async Task RespondWithSwaggerYaml(HttpResponse response, OpenApiDocument swagger)
        {
            ...
            using (var textWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if (_options.SerializeAsV2) swagger.SerializeAsV2(yamlWriter);
                else swagger.SerializeAsV3(yamlWriter);
