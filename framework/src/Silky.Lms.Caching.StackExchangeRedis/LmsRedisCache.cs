...
namespace Silky.Lms.Caching.StackExchangeRedis
{
    public class LmsRedisCache : RedisCache, ICacheSupportsMultipleItems
    {
        ...
        public LmsRedisCache(IOptions<RedisCacheOptions> optionsAccessor)
